...
export default function Map() {
    return (
    <svg id="Map-svg" viewBox="0 0 670.2 432.4"  xmlSpace="preserve" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
        <defs>
        ...
        <g clipPath="url(#Map-mask)" fill="#686868" id="Map-shape">
          ...
          <g data-location="TR">
            <circle className="Pin-back" cx={160} cy={210} r="2.5" fill="#fff" fillOpacity="0.5" />
            <circle className="Pin-front" cx={160} cy={210} r="2.5" fill="#fff" />
          </g>
          <g data-location="NY">
          ...
          <g data-location="SF">
            <circle className="Pin-back" cx="94.5" cy="229.5" r="2.5" fill="#fff" fillOpacity="0.5" />
            <circle className="Pin-front" cx="94.5" cy="229.5" r="2.5" fill="#fff" />
          </g>
          <g data-location="AM">
          ...
          <g data-location="FR">
            ...
            <g data-location="BLR">
              <circle className="Pin-back" cx={474} cy={277} r="2.5" fill="#fff" fillOpacity="0.5" />
              <circle className="Pin-front" cx={474} cy={277} r="2.5" fill="#fff" />
            </g>
          </canvas></g>
      </svg>
    );
